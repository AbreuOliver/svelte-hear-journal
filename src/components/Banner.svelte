<script lang="ts">
  import { bannerDismissed, themeColor } from "./store";
...
{#if !$bannerDismissed}
  <div
    id="sticky-banner"
    tabindex="-1"
    class="fixed bottom-[4rem] left-0 z-50 flex justify-between w-full p-6 border-b border-gray-200 bg-yellow-300 dark:bg-blue-600 text-white dark:border-gray-600 lg:bottom-[5.5rem] h-22 text-lg"
  >
    <div class="flex items-center mx-auto">
      <p
        class="flex items-center text-sm font-normal text-gray-500 dark:text-gray-100"
      >
        <span
