...
<main class="w-full px-5 pb-[10rem]">
  ...
  <Card
    class="max-w-full min-w-full drop-shadow-none my-0 horizontal bg-gray-200 dark:bg-gray-700"
  >
    <!-- ///////////////////////// -->
    <div class="flex justify-end items-center my-2 border-0">
      <p
        class="my-0 font-normal text-gray-700 dark:text-gray-400 leading-tight grow grow-2"
      >
        Reading Plan
      </p>
      <Button class="grow-1"><Chevron>{planSelected}</Chevron></Button>
      <Dropdown
        placement="bottom"
