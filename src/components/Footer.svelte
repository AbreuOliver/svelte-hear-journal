...
<footer
  class={`fixed bottom-0 left-0 z-50 border-t w-full ${footerHeight} bg-white dark:bg-gray-700 border-gray-500 dark:border-gray-600 text-xs md:h-[5.5rem]`}
>
